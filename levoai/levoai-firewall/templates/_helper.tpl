{{/*
Name used for Kubernetes resources. Supports nameOverride to decouple
the chart package name from runtime resource names.
*/}}
{{- define "vigil.name" -}}
{{- default .Chart.Name .Values.nameOverride | trim | lower | replace "_" "-" | trunc 63 | trimSuffix "-" -}}
{{- end }}
